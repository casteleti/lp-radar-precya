...
export function FounderSection() {
  return (
    <section className="bg-surface/55 py-14 md:py-20" aria-labelledby="founder-title">
      <Container>
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <Motion variant="scale-in" delay={120}>
            <Card elevated className="overflow-hidden p-0">
              <div className="aspect-[4/3] bg-primary-light/18 p-6">
                <div className="flex h-full flex-col justify-between rounded-[1.5rem] border border-border bg-surface p-5 shadow-soft">
                  <div className="flex items-center gap-4">
                    <div className="grid h-16 w-16 place-items-center rounded-2xl bg-primary text-2xl font-extrabold text-white">
                      P
                    </div>
                    <div>
                      <p className="font-extrabold text-text-primary">Espaco para foto ou video</p>
